...
// Logo de Binance (rombo dorado) — incrustado desde assets/Binance_Logo.svg del repo original.
const XML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 126.611 126.611">
